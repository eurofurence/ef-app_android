 ...
 */
fun Context.receiver(action: String, method: (Intent) -> Unit) = EmbeddedBroadcastReceiver(this, IntentFilter(action), method)
 ...
 * @param method The method to invoke when triggered
 */
fun Context.localReceiver(action: String, method: (Intent) -> Unit) = EmbeddedLocalBroadcastReceiver(this, IntentFilter(action), method)