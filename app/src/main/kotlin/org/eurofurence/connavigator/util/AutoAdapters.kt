 ...
 * @param receiver The context to create the view with.
 */
class AutoBehaviour<E, T>(val receiver: T) {
 ...
 */
class AutoViewHolder<E>(val autoBehaviour: AutoBehaviour<E, Context>, view: View) :
 ...
 */
abstract class AutoAdapter<E>(
    val id: E.() -> Any?,
    val create: AutoBehaviour<E, Context>.() -> View
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AutoViewHolder<E> {
        val autoBinder = AutoBehaviour<E, Context>(parent.context)
        ...
        holder.autoBehaviour.binder(
            ...
            object : AbstractList<E>() {
                ...
                override fun get(index: Int) =
                    getItem(holder.adapterPosition - 1 - index)
            },
            object : AbstractList<E>() {
                override val size: Int
                    get() = maxOf(0, itemCount - (holder.adapterPosition + 1))
 ...
 */
class ListAutoAdapter<E>(id: E.() -> Any?, create: AutoBehaviour<E, Context>.() -> View) :
    AutoAdapter<E>(id, create) {
