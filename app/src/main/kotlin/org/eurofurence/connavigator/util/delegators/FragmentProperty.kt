 ...
 */
class FragmentProperty<in T, out U : Fragment>(val findFragment: (T, String) -> U) {
 ...
 */
inline fun <reified T : Fragment> Activity.fragmentByTag() = FragmentProperty {
 ...
 * @param T The class of the fragment to inject
 */
inline fun <reified T : Fragment> FragmentActivity.fragmentByTag() = FragmentProperty {
