...
fun Context.queryEndpoint(scope: String = "unscoped") {
    val request = Intent(this, QueryIntentService::class.java)
...
fun Context.createEndpointReceiver(scope: String = "unscoped", handler: (Endpoint) -> Unit): Registered =
        QueryIntentService.ResponseReceiver(this, "endpoint", Endpoint::class.java, scope, Bridge.fromSingle(handler))
...
fun Context.createEventConferenceDayReceiver(scope: String = "unscoped", handler: (List<EventConferenceDay>) -> Unit): Registered =
        QueryIntentService.ResponseReceiver(this, "eventConferenceDay", EventConferenceDay::class.java, scope, Bridge.fromSome(handler))
...
fun Context.createEventConferenceRoomReceiver(scope: String = "unscoped", handler: (List<EventConferenceRoom>) -> Unit): Registered =
        QueryIntentService.ResponseReceiver(this, "eventConferenceRoom", EventConferenceRoom::class.java, scope, Bridge.fromSome(handler))
...
fun Context.createEventConferenceTrackReceiver(scope: String = "unscoped", handler: (List<EventConferenceTrack>) -> Unit): Registered =
        QueryIntentService.ResponseReceiver(this, "eventConferenceTrack", EventConferenceTrack::class.java, scope, Bridge.fromSome(handler))
...
fun Context.createEventEntryReceiver(scope: String = "unscoped", handler: (List<EventEntry>) -> Unit): Registered =
        QueryIntentService.ResponseReceiver(this, "eventEntry", EventEntry::class.java, scope, Bridge.fromSome(handler))
...
fun Context.createImageReceiver(scope: String = "unscoped", handler: (List<Image>) -> Unit): Registered =
        QueryIntentService.ResponseReceiver(this, "image", Image::class.java, scope, Bridge.fromSome(handler))
...
fun Context.createInfoReceiver(scope: String = "unscoped", handler: (List<Info>) -> Unit): Registered =
        QueryIntentService.ResponseReceiver(this, "info", Info::class.java, scope, Bridge.fromSome(handler))
...
fun Context.createInfoGroupReceiver(scope: String = "unscoped", handler: (List<InfoGroup>) -> Unit): Registered =
        QueryIntentService.ResponseReceiver(this, "infoGroup", InfoGroup::class.java, scope, Bridge.fromSome(handler))