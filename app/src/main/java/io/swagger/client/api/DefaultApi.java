...
public class DefaultApi {
  ...
  */
  ...
  // create path and map variables
  String path = "/Dealer".replaceAll("\\{format\\}","json");
  ...
  "application/json"
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (List<Dealer>) ApiInvoker.deserialize(localVarResponse, "array", Dealer.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
  ...
  */
  public List<MapEntry> mapEntryGet (Date since) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  

  // create path and map variables
  String path = "/MapEntry".replaceAll("\\{format\\}","json");
  ...
  "application/json"
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (List<MapEntry>) ApiInvoker.deserialize(localVarResponse, "array", MapEntry.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
   ...
   * @param since Delta reference, date time in **ISO 8610**. If set, only items with a *LastChangeDateTimeUtc* &gt;&#x3D; the specified value will be returned. If not set, API will return the current set of records without deleted items. If set, items deleted since the delta specified will be returned with an *IsDeleted* flag set.
  */
  public void mapEntryGet (Date since, final Response.Listener<List<MapEntry>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<MapEntry>) ApiInvoker.deserialize(localVarResponse,  "array", MapEntry.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  ...
  // create path and map variables
  String path = "/Map".replaceAll("\\{format\\}","json");
