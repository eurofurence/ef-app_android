...
public class EventConferenceRoomsApi {
  ...
  List<Pair> queryParams = new ArrayList<Pair>();
      ...
      try {
        ...
        if(localVarResponse != null){
           return (EventConferenceRoomRecord) ApiInvoker.deserialize(localVarResponse, "", EventConferenceRoomRecord.class);
        } else {
           return null;
        }
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EventConferenceRoomRecord) ApiInvoker.deserialize(localVarResponse,  "", EventConferenceRoomRecord.class));
  ...
  */
  ...
  List<Pair> queryParams = new ArrayList<Pair>();
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (List<EventConferenceRoomRecord>) ApiInvoker.deserialize(localVarResponse, "array", EventConferenceRoomRecord.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<EventConferenceRoomRecord>) ApiInvoker.deserialize(localVarResponse,  "array", EventConferenceRoomRecord.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
