  ...
  */
  ...
  List<Pair> queryParams = new ArrayList<Pair>();
      ...
      try {
        ...
        if(localVarResponse != null){
           return (AnnouncementRecord) ApiInvoker.deserialize(localVarResponse, "", AnnouncementRecord.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((AnnouncementRecord) ApiInvoker.deserialize(localVarResponse,  "", AnnouncementRecord.class));
  ...
  */
  ...
  List<Pair> queryParams = new ArrayList<Pair>();
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (List<AnnouncementRecord>) ApiInvoker.deserialize(localVarResponse, "array", AnnouncementRecord.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
