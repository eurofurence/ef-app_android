  ...
  List<Pair> queryParams = new ArrayList<Pair>();
      ...
      try {
        ...
        if(localVarResponse != null){
           return (List<EventFeedbackRecord>) ApiInvoker.deserialize(localVarResponse, "array", EventFeedbackRecord.class);
        } else {
           return null;
        }
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<EventFeedbackRecord>) ApiInvoker.deserialize(localVarResponse,  "array", EventFeedbackRecord.class));
