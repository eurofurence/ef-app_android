...
public class EventConferenceTracksApi {
  ...
  List<Pair> queryParams = new ArrayList<Pair>();
      ...
      try {
        ...
        if(localVarResponse != null){
           return (EventConferenceTrackRecord) ApiInvoker.deserialize(localVarResponse, "", EventConferenceTrackRecord.class);
        } else {
           return null;
        }
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EventConferenceTrackRecord) ApiInvoker.deserialize(localVarResponse,  "", EventConferenceTrackRecord.class));
  ...
  */
  ...
  List<Pair> queryParams = new ArrayList<Pair>();
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (List<EventConferenceTrackRecord>) ApiInvoker.deserialize(localVarResponse, "array", EventConferenceTrackRecord.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<EventConferenceTrackRecord>) ApiInvoker.deserialize(localVarResponse,  "array", EventConferenceTrackRecord.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
