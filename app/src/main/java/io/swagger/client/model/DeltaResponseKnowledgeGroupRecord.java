...
public class DeltaResponseKnowledgeGroupRecord {
  ...
  public boolean equals(Object o) {
    ...
    return (this.storageLastChangeDateTimeUtc == null ? deltaResponseKnowledgeGroupRecord.storageLastChangeDateTimeUtc == null : this.storageLastChangeDateTimeUtc.equals(deltaResponseKnowledgeGroupRecord.storageLastChangeDateTimeUtc)) &&
        (this.storageDeltaStartChangeDateTimeUtc == null ? deltaResponseKnowledgeGroupRecord.storageDeltaStartChangeDateTimeUtc == null : this.storageDeltaStartChangeDateTimeUtc.equals(deltaResponseKnowledgeGroupRecord.storageDeltaStartChangeDateTimeUtc)) &&
        (this.removeAllBeforeInsert == null ? deltaResponseKnowledgeGroupRecord.removeAllBeforeInsert == null : this.removeAllBeforeInsert.equals(deltaResponseKnowledgeGroupRecord.removeAllBeforeInsert)) &&
        (this.changedEntities == null ? deltaResponseKnowledgeGroupRecord.changedEntities == null : this.changedEntities.equals(deltaResponseKnowledgeGroupRecord.changedEntities)) &&
        (this.deletedEntities == null ? deltaResponseKnowledgeGroupRecord.deletedEntities == null : this.deletedEntities.equals(deltaResponseKnowledgeGroupRecord.deletedEntities));
  }
