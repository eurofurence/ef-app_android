...
public class DeltaResponseMapRecord  {
  ...
  private List<MapRecord> changedEntities = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public List<MapRecord> getChangedEntities() {
    return changedEntities;
  }
  public void setChangedEntities(List<MapRecord> changedEntities) {
  ...
  public boolean equals(Object o) {
    ...
    DeltaResponseMapRecord deltaResponseMapRecord = (DeltaResponseMapRecord) o;
    return (storageLastChangeDateTimeUtc == null ? deltaResponseMapRecord.storageLastChangeDateTimeUtc == null : storageLastChangeDateTimeUtc.equals(deltaResponseMapRecord.storageLastChangeDateTimeUtc)) &&
        (storageDeltaStartChangeDateTimeUtc == null ? deltaResponseMapRecord.storageDeltaStartChangeDateTimeUtc == null : storageDeltaStartChangeDateTimeUtc.equals(deltaResponseMapRecord.storageDeltaStartChangeDateTimeUtc)) &&
        (removeAllBeforeInsert == null ? deltaResponseMapRecord.removeAllBeforeInsert == null : removeAllBeforeInsert.equals(deltaResponseMapRecord.removeAllBeforeInsert)) &&
        (changedEntities == null ? deltaResponseMapRecord.changedEntities == null : changedEntities.equals(deltaResponseMapRecord.changedEntities)) &&
        (deletedEntities == null ? deltaResponseMapRecord.deletedEntities == null : deletedEntities.equals(deltaResponseMapRecord.deletedEntities));
  }
  ...
  public String toString()  {
    ...
    sb.append("class DeltaResponseMapRecord {\n");
