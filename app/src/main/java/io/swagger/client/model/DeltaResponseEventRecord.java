...
public class DeltaResponseEventRecord  {
  ...
  private List<EventRecord> changedEntities = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public List<EventRecord> getChangedEntities() {
    return changedEntities;
  }
  public void setChangedEntities(List<EventRecord> changedEntities) {
  ...
  public boolean equals(Object o) {
    ...
    DeltaResponseEventRecord deltaResponseEventRecord = (DeltaResponseEventRecord) o;
    return (storageLastChangeDateTimeUtc == null ? deltaResponseEventRecord.storageLastChangeDateTimeUtc == null : storageLastChangeDateTimeUtc.equals(deltaResponseEventRecord.storageLastChangeDateTimeUtc)) &&
        (storageDeltaStartChangeDateTimeUtc == null ? deltaResponseEventRecord.storageDeltaStartChangeDateTimeUtc == null : storageDeltaStartChangeDateTimeUtc.equals(deltaResponseEventRecord.storageDeltaStartChangeDateTimeUtc)) &&
        (removeAllBeforeInsert == null ? deltaResponseEventRecord.removeAllBeforeInsert == null : removeAllBeforeInsert.equals(deltaResponseEventRecord.removeAllBeforeInsert)) &&
        (changedEntities == null ? deltaResponseEventRecord.changedEntities == null : changedEntities.equals(deltaResponseEventRecord.changedEntities)) &&
        (deletedEntities == null ? deltaResponseEventRecord.deletedEntities == null : deletedEntities.equals(deltaResponseEventRecord.deletedEntities));
  }
  ...
  public String toString()  {
    ...
    sb.append("class DeltaResponseEventRecord {\n");
