...
public class DeltaResponseEventConferenceTrackRecord {
  ...
  public boolean equals(Object o) {
    ...
    return (this.storageLastChangeDateTimeUtc == null ? deltaResponseEventConferenceTrackRecord.storageLastChangeDateTimeUtc == null : this.storageLastChangeDateTimeUtc.equals(deltaResponseEventConferenceTrackRecord.storageLastChangeDateTimeUtc)) &&
        (this.storageDeltaStartChangeDateTimeUtc == null ? deltaResponseEventConferenceTrackRecord.storageDeltaStartChangeDateTimeUtc == null : this.storageDeltaStartChangeDateTimeUtc.equals(deltaResponseEventConferenceTrackRecord.storageDeltaStartChangeDateTimeUtc)) &&
        (this.removeAllBeforeInsert == null ? deltaResponseEventConferenceTrackRecord.removeAllBeforeInsert == null : this.removeAllBeforeInsert.equals(deltaResponseEventConferenceTrackRecord.removeAllBeforeInsert)) &&
        (this.changedEntities == null ? deltaResponseEventConferenceTrackRecord.changedEntities == null : this.changedEntities.equals(deltaResponseEventConferenceTrackRecord.changedEntities)) &&
        (this.deletedEntities == null ? deltaResponseEventConferenceTrackRecord.deletedEntities == null : this.deletedEntities.equals(deltaResponseEventConferenceTrackRecord.deletedEntities));
  }
