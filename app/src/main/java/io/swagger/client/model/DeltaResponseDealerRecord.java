...
public class DeltaResponseDealerRecord  {
  ...
  public boolean equals(Object o) {
    ...
    return (storageLastChangeDateTimeUtc == null ? deltaResponseDealerRecord.storageLastChangeDateTimeUtc == null : storageLastChangeDateTimeUtc.equals(deltaResponseDealerRecord.storageLastChangeDateTimeUtc)) &&
        (storageDeltaStartChangeDateTimeUtc == null ? deltaResponseDealerRecord.storageDeltaStartChangeDateTimeUtc == null : storageDeltaStartChangeDateTimeUtc.equals(deltaResponseDealerRecord.storageDeltaStartChangeDateTimeUtc)) &&
        (removeAllBeforeInsert == null ? deltaResponseDealerRecord.removeAllBeforeInsert == null : removeAllBeforeInsert.equals(deltaResponseDealerRecord.removeAllBeforeInsert)) &&
        (changedEntities == null ? deltaResponseDealerRecord.changedEntities == null : changedEntities.equals(deltaResponseDealerRecord.changedEntities)) &&
        (deletedEntities == null ? deltaResponseDealerRecord.deletedEntities == null : deletedEntities.equals(deltaResponseDealerRecord.deletedEntities));
  }
