...
public class InfoGroup extends EntityBase implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(name, infoGroup.name) &&
        Objects.equals(description, infoGroup.description) &&
        Objects.equals(lastChangeDateTimeUtc, infoGroup.lastChangeDateTimeUtc) &&
        Objects.equals(order, infoGroup.order) &&
        Objects.equals(isDeleted, infoGroup.isDeleted) &&
        Objects.equals(id, infoGroup.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, lastChangeDateTimeUtc, order, isDeleted, id);
  }
