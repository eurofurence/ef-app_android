...
public class DeltaResponseImageRecord {
  ...
  public boolean equals(Object o) {
    ...
    return (this.storageLastChangeDateTimeUtc == null ? deltaResponseImageRecord.storageLastChangeDateTimeUtc == null : this.storageLastChangeDateTimeUtc.equals(deltaResponseImageRecord.storageLastChangeDateTimeUtc)) &&
        (this.storageDeltaStartChangeDateTimeUtc == null ? deltaResponseImageRecord.storageDeltaStartChangeDateTimeUtc == null : this.storageDeltaStartChangeDateTimeUtc.equals(deltaResponseImageRecord.storageDeltaStartChangeDateTimeUtc)) &&
        (this.removeAllBeforeInsert == null ? deltaResponseImageRecord.removeAllBeforeInsert == null : this.removeAllBeforeInsert.equals(deltaResponseImageRecord.removeAllBeforeInsert)) &&
        (this.changedEntities == null ? deltaResponseImageRecord.changedEntities == null : this.changedEntities.equals(deltaResponseImageRecord.changedEntities)) &&
        (this.deletedEntities == null ? deltaResponseImageRecord.deletedEntities == null : this.deletedEntities.equals(deltaResponseImageRecord.deletedEntities));
  }
