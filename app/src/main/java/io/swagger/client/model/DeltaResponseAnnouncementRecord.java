...
public class DeltaResponseAnnouncementRecord {
  ...
  public boolean equals(Object o) {
    ...
    return (this.storageLastChangeDateTimeUtc == null ? deltaResponseAnnouncementRecord.storageLastChangeDateTimeUtc == null : this.storageLastChangeDateTimeUtc.equals(deltaResponseAnnouncementRecord.storageLastChangeDateTimeUtc)) &&
        (this.storageDeltaStartChangeDateTimeUtc == null ? deltaResponseAnnouncementRecord.storageDeltaStartChangeDateTimeUtc == null : this.storageDeltaStartChangeDateTimeUtc.equals(deltaResponseAnnouncementRecord.storageDeltaStartChangeDateTimeUtc)) &&
        (this.removeAllBeforeInsert == null ? deltaResponseAnnouncementRecord.removeAllBeforeInsert == null : this.removeAllBeforeInsert.equals(deltaResponseAnnouncementRecord.removeAllBeforeInsert)) &&
        (this.changedEntities == null ? deltaResponseAnnouncementRecord.changedEntities == null : this.changedEntities.equals(deltaResponseAnnouncementRecord.changedEntities)) &&
        (this.deletedEntities == null ? deltaResponseAnnouncementRecord.deletedEntities == null : this.deletedEntities.equals(deltaResponseAnnouncementRecord.deletedEntities));
  }
