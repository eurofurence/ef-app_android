...
public class DeltaResponseAnnouncementRecord  {
  ...
  private List<AnnouncementRecord> changedEntities = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public List<AnnouncementRecord> getChangedEntities() {
    return changedEntities;
  }
  public void setChangedEntities(List<AnnouncementRecord> changedEntities) {
  ...
  public boolean equals(Object o) {
    ...
    DeltaResponseAnnouncementRecord deltaResponseAnnouncementRecord = (DeltaResponseAnnouncementRecord) o;
    return (storageLastChangeDateTimeUtc == null ? deltaResponseAnnouncementRecord.storageLastChangeDateTimeUtc == null : storageLastChangeDateTimeUtc.equals(deltaResponseAnnouncementRecord.storageLastChangeDateTimeUtc)) &&
        (storageDeltaStartChangeDateTimeUtc == null ? deltaResponseAnnouncementRecord.storageDeltaStartChangeDateTimeUtc == null : storageDeltaStartChangeDateTimeUtc.equals(deltaResponseAnnouncementRecord.storageDeltaStartChangeDateTimeUtc)) &&
        (removeAllBeforeInsert == null ? deltaResponseAnnouncementRecord.removeAllBeforeInsert == null : removeAllBeforeInsert.equals(deltaResponseAnnouncementRecord.removeAllBeforeInsert)) &&
        (changedEntities == null ? deltaResponseAnnouncementRecord.changedEntities == null : changedEntities.equals(deltaResponseAnnouncementRecord.changedEntities)) &&
