...
public class DeltaResponseKnowledgeEntryRecord {
  ...
  public boolean equals(Object o) {
    ...
    return (this.storageLastChangeDateTimeUtc == null ? deltaResponseKnowledgeEntryRecord.storageLastChangeDateTimeUtc == null : this.storageLastChangeDateTimeUtc.equals(deltaResponseKnowledgeEntryRecord.storageLastChangeDateTimeUtc)) &&
        (this.storageDeltaStartChangeDateTimeUtc == null ? deltaResponseKnowledgeEntryRecord.storageDeltaStartChangeDateTimeUtc == null : this.storageDeltaStartChangeDateTimeUtc.equals(deltaResponseKnowledgeEntryRecord.storageDeltaStartChangeDateTimeUtc)) &&
        (this.removeAllBeforeInsert == null ? deltaResponseKnowledgeEntryRecord.removeAllBeforeInsert == null : this.removeAllBeforeInsert.equals(deltaResponseKnowledgeEntryRecord.removeAllBeforeInsert)) &&
        (this.changedEntities == null ? deltaResponseKnowledgeEntryRecord.changedEntities == null : this.changedEntities.equals(deltaResponseKnowledgeEntryRecord.changedEntities)) &&
        (this.deletedEntities == null ? deltaResponseKnowledgeEntryRecord.deletedEntities == null : this.deletedEntities.equals(deltaResponseKnowledgeEntryRecord.deletedEntities));
  }
